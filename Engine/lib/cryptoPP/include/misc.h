...
class CPPCPPSingleton
{
public:
	CPPCPPSingleton(F objectFactory = F()) : m_objectFactory(objectFactory) {}
...
const T & CPPCPPSingleton<T, F, instance>::Ref(CRYPTOPP_NOINLINE_DOTDOTDOT) const
{
