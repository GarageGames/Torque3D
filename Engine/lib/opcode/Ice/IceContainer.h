...
#define __ICECONTAINER_H__
	...
	class ICECORE_API OPC_Container
	{
		public:
		// Constructor / Destructor
								OPC_Container();
								OPC_Container(const OPC_Container& object);
								OPC_Container(udword size, float growth_factor);
								~OPC_Container();
		// Management
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	OPC_Container&		Add(udword entry)
								{
									// Resize if needed
		...
		inline_	OPC_Container&		Add(const udword* entries, udword nb)
								{
									// Resize if needed
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	OPC_Container&		Add(float entry)
								{
									// Resize if needed
									if(mCurNbEntries==mMaxNbEntries)	Resize();
		...
		inline_	OPC_Container&		Add(const float* entries, udword nb)
								{
									// Resize if needed
									if(mCurNbEntries+nb>mMaxNbEntries)	Resize(nb);
		...
		//! Add unique [slow]
		inline_	OPC_Container&		AddUnique(udword entry)
								{
		...
		// Helpers
				OPC_Container&		FindNext(udword& entry, FindMode find_mode=FIND_CLAMP);
				OPC_Container&		FindPrev(udword& entry, FindMode find_mode=FIND_CLAMP);
		// Data access.
		...
		//! Operator for "OPC_Container A = OPC_Container B"
				void			operator = (const OPC_Container& object);
