...
{
   textureName = "data/materials/particles/impact";
   dragCoeffiecient = 0;
   ...
   times[1] = 0.494118;
   times[2] = 1.0;
   animTexName = "data/materials/particles/impact";
...
datablock ParticleData(GrenadeSplashMist)
{
   ...
   textureName = "data/materials/particles/smoke";
...
datablock ParticleData(GrenadeSplashParticle)
{
   ...
   textureName = "data/materials/particles/droplet";
...
{
   textureName = "data/materials/particles/fireball.png";
   dragCoeffiecient = 0;
   ...
   times[1] = 0.25;
   times[2] = 0.5;
   animTexName = "data/materials/particles/fireball.png";
   times[3] = "1";
...
{
   textureName = "data/materials/particles/smoke.png";
   ...
   times[1] = 0.494118;
   times[2] = 1.0;
   animTexName = "data/materials/particles/smoke.png";
...
{
   textureName = "data/materials/particles/Sparkparticle";
   dragCoefficient = 1;
   gravityCoefficient = 0.0;
   inheritedVelFactor = 0.2;
   constantAcceleration = 0.0;
...
datablock ParticleData(GrenadeExpSmoke)
{
   ...
   times[1] = 0.498039;
   times[2] = 1;
   animTexName = "data/materials/particles/smoke";
   times[3] = "1";
};
...
{
   textureName = "data/materials/particles/steam";
   dragCoefficient = 1.0;
...
{
   textureName = "data/materials/particles/spark_wet";
   dragCoefficient = 1;
   gravityCoefficient = 0.0;
   inheritedVelFactor = 0.2;
   constantAcceleration = 0.0;
...
{
   textureName = "data/materials/particles/bubble";
   dragCoefficient = 0.0;
