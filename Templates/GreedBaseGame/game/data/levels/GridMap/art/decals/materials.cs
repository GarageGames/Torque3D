...
{
   mapTo = "unmapped_mat";
   diffuseMap[0] = "data/levels/GridMap/art/decals/gm_crashtestmarkings.dds";
...
{
   mapTo = "unmapped_mat";
   diffuseMap[0] = "data/levels/GridMap/art/decals/road-01_tracks_large_decal_01.dds";
   useAnisotropic[0] = "1";
   castShadows = "0";
   translucent = "1";
   translucentZWrite = "1";
...
{
   mapTo = "unmapped_mat";
   diffuseMap[0] = "data/levels/GridMap/art/decals/road-01_decals.dds";
   materialTag0 = "RoadAndPath";
   translucent = "1";
   materialTag1 = "beamng";
   specular[0] = "0.992157 0.992157 0.992157 1";
   specularPower[0] = "1";
   specularMap[0] = "data/levels/GridMap/art/decals/Road-01_s.dds";
   translucentZWrite = "1";
   castShadows = "0";
   normalMap[0] = "data/levels/GridMap/art/decals/road-01_n.dds";
};
