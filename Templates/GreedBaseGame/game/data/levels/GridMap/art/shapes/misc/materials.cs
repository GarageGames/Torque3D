...
{
   mapTo = "GridMat";
   diffuseMap[0] = "data/levels/GridMap/art/shapes/buildings/concrete-01_GM_d.dds";
   materialTag0 = "beamng";
   specularPower[0] = "1";
   materialTag1 = "beamng";
   ...
   normalMap[0] = "data/levels/GridMap/art/shapes/buildings/concrete-01_GM_n2.dds";
   specularStrength[0] = "0.0980392";
   specularMap[0] = "data/levels/GridMap/art/shapes/buildings/Concrete-01_s.dds";
   detailMap[0] = "data/levels/GridMap/art/shapes/buildings/concrete-01_Macro_d.dds";
...
{
   mapTo = "GridMat_alpha";
   diffuseMap[0] = "data/levels/GridMap/art/shapes/misc/grid_10_b_d.dds";
   materialTag0 = "beamng";
   specularPower[0] = "1";
   materialTag1 = "beamng";
   materialTag2 = "Industrial";
...
singleton Material(glass_01)
{
   ...
   translucentZWrite = "0";
   diffuseMap[0] = "data/levels/GridMap/art/shapes/misc/glass_01_d.dds";
   translucent = "1";
   pixelSpecular[0] = "1";
...
singleton Material(billboards_01_a_misc_billboard_title)
{
   ...
   diffuseMap[0] = "data/levels/GridMap/art/shapes/misc/billboards_01b";
   specular[0] = "0.5 0.5 0.5 1";
   specularPower[0] = "1";
   doubleSided = "1";
   translucentBlendOp = "None";
