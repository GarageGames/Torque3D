...
function setTitle::loadDialog(%this, %ctrl)
{
   %this.ctrl = %ctrl;
   %this.oldTitleName = %ctrl.getWindowTitle();
   Canvas.pushDialog(setTitle);
   TitleText.text = %this.oldTitleName;
}

function setTitle::resetValue(%this)
{
   %this.setValue(%this.oldTitleName);
}

function setTitle::setValue(%this, %value)
{
