...
function initializeInGameEditor()
{
   echo(" % - Initializing In-game GUI Editor");
      
   // Load GUI
   exec( "./gui/setTitle.ed.gui" );
   exec( "./gui/windowSettings.ed.gui" );
   exec( "./gui/changeFontSize.ed.gui" );
   
   // Load Scripts
   exec( "./scripts/setTitle.cs" );
   exec( "./scripts/windowSettings.cs" );
   exec( "./scripts/ingameContext.cs" );
   exec( "./scripts/changeFontSize.cs" );
   
   new GuiControl(IngameContext, IngameGuiGroup);
}

function destroyInGameEditor()
{
}