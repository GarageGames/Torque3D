...
<Project DefaultTargets="Build" ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    ...
    <TargetName Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">{$projOutName}_DEBUG DLL</TargetName>
    ...
    <TargetName Condition="'$(Configuration)|$(Platform)'=='Optimized Debug|x64'">{$projOutName}_OPTIMIZEDDEBUG DLL</TargetName>
    ...
    <TargetName Condition="'$(Configuration)|$(Platform)'=='Release|x64'">{$projOutName} DLL</TargetName>
  </PropertyGroup>
